  ...
  Widget build(BuildContext context) {
    ...
    Widget? _getScreen(String? route) {
      switch (route) {
        ...
        case 'lostfound': return LostScreen();
        case 'tips': return PetCareScreen();
        // ADDED NEW CASE: Redirect to VetConnectScreen
        case 'vet': return VetConnectScreen();
        default: return null;
      }
    }
